...
def init():
   ...
   orbs = [0]*15
   orbs[0]  = [0,1,2,3]				# _end
   orbs[1]  = [4,5,6,7,8]                       # _fe3
   orbs[2]  = [9,10,11,12,13,14,15]	        # _s 
   orbs[3]  = [16,17,18,19,20]                  # _fe2
   orbs[4]  = [21,22]				# _s
   orbs[5]  = [23,24,25,26,27]			# _fe1
   orbs[6]  = [28,29,30,31,32]			# _fe4
   orbs[7]  = [33,34,35,36,37,38,39]   	        # _s_middle
   orbs[8]  = [40,41,42,43,44]			# _fe8
   orbs[9]  = [45,46,47,48,49]			# _fe5
   orbs[10] = [50,51,52,53,54,55,56,57,58]      # _s
   orbs[11] = [59,60,61,62,63] 			# _fe7
   orbs[12] = [64,65]				# _s
   orbs[13] = [66,67,68,69,70]			# _fe6
   orbs[14] = [71,72,73,74]			# _end
   # doubly occupancy
